...
import { useUser } from '~/_old/composables';
...
import UserAddressDetails from '~/_old/components/UserAddressDetails.vue';
import { addressFromApiToForm, formatAddressReturnToData } from '~/_old/helpers/checkout/address';
import { mergeItem } from '~/_old/helpers/asyncLocalStorage';
import { isPreviousStepValid } from '~/_old/helpers/checkout/steps';
...
export default defineComponent({
  ...
  components: {
    ...
    ValidationProvider,
    ValidationObserver,
    UserBillingAddresses: () => import('~/_old/components/Checkout/UserBillingAddresses.vue'),
    UserAddressDetails,
  },
  setup() {
